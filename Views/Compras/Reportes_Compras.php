...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="/SmartShop/Reportes_Ventas"><i class="fa fa-dashboard"></i> Reporte de Compras</a></li>
  ...
  <section class="content container-fluid">    
    ...
    <div class="row">
      <div class="col-xs-12">
        <form target="_blank" action="/SmartShop/Reportes/Compras" method="POST">
...
<script type="text/javascript">
  ...
  //Funciones AJAX
    ...
    $.ajax({
      data: {"id_usu":id_usuario,"fecha1":fecha[0],"fecha2":fecha[1]},
      type: 'POST',      
      url: '/SmartShop/compras/MostrarItemsAJAX_Reportes',
