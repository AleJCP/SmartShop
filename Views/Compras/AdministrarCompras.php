...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-edit"></i> Administrar Compras        
      </h1>
      <ol class="breadcrumb">
        <li><a href="/SmartShop/Ventas"><i class="fa fa-dashboard"></i> Compras</a></li>
            ...
            <div class="box-header">
              ...
              <div class="box-tools">              
                  ...
                  <div class="col-md-4 col-xs-12">
                    <a href="/SmartShop/Compras/NuevaCompra" class="btn btn-default"><i class="fa fa-plus"></i> Añadir Compra</a>                
                  </div>
                  ...
                  <div class="col-md-4 col-xs-12">
                     <select id="showElementsby" type="form-control" class="btn btn-default" >
                      ...
                      <option value="<?php echo $data['totalCompras']; ?>">Todos</option>
                    </select>                   
                  </div>
...
<script type="text/javascript">
  ...
  function load(page,itemsbypage){    
    ...
    $.ajax({
      ...
      type: 'POST',      
      url: '/SmartShop/Compras/MostrarItemsAJAX',
