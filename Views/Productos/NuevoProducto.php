...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-edit"></i> Añadir Producto
     ...
     <div class="row">
      <div class="col-xs-12">
        <div class="box box-primary"> 
          ...
          <div class="box-body">
            <img id="imgThumb" class="img-fluid center-block" style="max-width: 200px; height: 200px" src="/SmartShop/Assets/Uploads/default.jpg" alt="">                      
          </div>
        </div>
         <div id="loaderForm" class="box box-widget">           
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
             ...
             <form id="form_AddProduct" action="" class="form-horizontal" enctype="multipart/form-data" charset="utf-8"><!--FORM--> 
                ...
                <div class="box-body">                  
                  <div class="form-group">
                   ...
                   <label for="CodigoInput" class="col-sm-2 control-label">Codigo*</label>
                    <div class="col-sm-4">
                     <input name="codigo" type="text" class="form-control" id="CodigoInput" placeholder="Codigo" required oninvalid="setCustomValidity('Rellena este campo');" onchange="try{setCustomValidity('')}catch(e){}">
                    </div>

                    <label for="NombreInput" class="col-sm-2 control-label">Nombre*</label>
                    <div class="col-sm-4">
                     <input name="nombre" type="text" class="form-control" id="NombreInput" placeholder="Nombre" required oninvalid="setCustomValidity('Rellena este campo');" onchange="try{setCustomValidity('')}catch(e){}">
                    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     <textarea name="descripcion" id="DescInput" style="max-width: 100%; min-width: 100%; min-height: 100px ;max-height: 200px;" class="form-control" rows="3" placeholder="Descripción" ></textarea>
                  </div>
                ...
                <div class="form-group">
                   ...
                   <div class="col-sm-4">
                      <select name="categoria" id="CategoriaInput" class="form-control" required oninvalid="setCustomValidity('Rellena este campo');" onchange="calcularUtilidad(); try{setCustomValidity('')}catch(e){}">
                    ...
                    <div class="col-sm-4">
                     <input name="presentacion" type="text" class="form-control" id="PresentacionInput" placeholder="Unidad/Combo...">
                    </div>
                ...
                <div class="form-group">
                   ...
                   <div class="col-sm-4">
                    <div class="input-group">
                       ...
                       <input name="costo" id="CostoInput" type="text" class="form-control" onkeyup="calcularUtilidad();" pattern="[0-9]+|([0-9]+[.][0-9]+)" required oninvalid="setCustomValidity('Completa este campo con el formato requerido');" onchange="try{setCustomValidity('')}catch(e){}">                
                    </div>
                  </div>
                  ...
                  <label for="UtilidadInput" class="col-sm-2 control-label">Utilidad*</label>
                    <div class="col-sm-4">
                      <div class="input-group">
                        ...
                        <input name="utilidad" id="UtilidadInput" type="text" class="form-control" onkeyup="calcularUtilidad();" pattern="[0-9]+|([0-9]+[.][0-9]+)" required oninvalid="setCustomValidity('Completa este campo con el formato requerido');" onchange="try{setCustomValidity('')}catch(e){}">                
                      </div>
                    </div>                    
                </div>
                <div class="form-group">
                   ...
                   <div class="col-sm-4">
                    <div class="input-group">
                       <span class="input-group-addon"><i class="fa fa-dollar"></i></span>
                       <input name="precio_bruto_venta" id="PrecioBrutoInput" type="text" class="form-control"  pattern="[$][0-9]+|([$][0-9]+[.][0-9]+)" required oninvalid="setCustomValidity('Completa este campo con el formato requerido');" onchange="try{setCustomValidity('')}catch(e){}">                
                    </div>
                  </div>
                  ...
                  <label for="PrecioInput" class="col-sm-2 control-label">Precio Venta (+ IVA)*</label>
                   <div class="col-sm-4">
                    <div class="input-group">
                       <span class="input-group-addon"><i class="fa fa-dollar"></i></span>
                       <input name="precio_venta" id="PrecioInput" type="text" class="form-control"  pattern="[$][0-9]+|([$][0-9]+[.][0-9]+)" required oninvalid="setCustomValidity('Completa este campo con el formato requerido');" onchange="try{setCustomValidity('')}catch(e){}">                
                    </div>
                  </div>                  
                  ...
                  <label for="" class="col-sm-2 control-label">Stock Inicial*</label>
                   <div class="col-sm-4">
                      <div class="input-group">
                       ...
                       <input name="stock" id="StockInput" type="text" class="form-control" pattern="[0-9]+" required oninvalid="setCustomValidity('Completa este campo con el formato requerido');" onchange="try{setCustomValidity('')}catch(e){}">
                     </div>
                  </div>
              ...
              <div class="box-footer">                
                <button type="submit" class="btn btn-primary pull-right">Añadir Producto</button>
              </div>
              <!-- /.box-footer -->
...
console.log(url);
  ...
  //AJAX
  $('#form_AddProduct').submit(function(ev){

    ev.preventDefault();
    var formData = new FormData(document.getElementById('form_AddProduct'));

    $.ajax({    
      data: formData,      
      type: 'POST',      
      url: '/SmartShop/Productos/addProductosAJAX',
      contentType: false,
      processData: false,
